...
function myFunction() {
  if (window.pageYOffset >= sticky) {
    ...
    <div class="site-blocks-cover overlay" style="height:500px;background-image: url(images/fofoo.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
 ...
 <?php 
 $result = mysqli_query($conn,"SELECT * FROM  corporates ");
