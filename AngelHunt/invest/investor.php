...
if($myArray['0'] === "type" and $myArray['1'] === "investor" and $myArray['2']==="loc" ){
     ...
     if($myArray['3'] !="NULL" and $myArray['4'] ==="NULL" and $myArray['5'] ==="NULL"){
           ...
           $result = mysqli_query($conn,"SELECT * FROM  investors WHERE type='$myArray[3]'") or die('Invalid query: ' . mysqli_error($conn));
      } 
      
      else if($myArray['3'] === "NULL" and $myArray['4'] ==="NULL" and $myArray['5']!="NULL"){
          
     $result = mysqli_query($conn,"SELECT * FROM  investors WHERE country='$myArray[5]'") or die('Invalid query: ' . mysqli_error($conn));
     
      }
      else if($myArray['3'] === "NULL" and $myArray['4'] !="NULL" and $myArray['5'] === "NULL"){
      $result = mysqli_query($conn,"SELECT * FROM  investors WHERE companyname='$myArray[4]'") or die('Invalid query: ' . mysqli_error($conn));
      }

    else if($myArray['3'] ==="NULL" and $myArray['4'] !="NULL" and $myArray['5'] !="NULL"){
    $result = mysqli_query($conn,"SELECT * FROM  investors WHERE companyname='$myArray[4]' and  country='$myArray[5]'") or die('Invalid query: ' . mysqli_error($conn));
    }
   else if($myArray['3'] !="NULL" and $myArray['4'] ==="NULL" and $myArray['5'] !="NULL"){
   $result = mysqli_query($conn,"SELECT * FROM  investors WHERE type='$myArray[3]' and  country='$myArray[5]'") or die('Invalid query: ' . mysqli_error($conn));
   }
  else if($myArray['3'] !="NULL" and $myArray['4'] !="NULL" and $myArray['5'] ==="NULL"){
   $result = mysqli_query($conn,"SELECT * FROM  investors WHERE type ='$myArray[3]' and  companyname='$myArray[4]'") or die('Invalid query: ' . mysqli_error($conn));
   }

  else if($myArray['3'] !="NULL" and $myArray['4'] !="NULL" and $myArray['5'] !="NULL"){
   $result = mysqli_query($conn,"SELECT * FROM  investors WHERE type='$myArray[3]' and companyname='$myArray[4]' and  country='$myArray[5]'") or die('Invalid query: ' . mysqli_error($conn));
}
}
...
<nav class="navbar navbar-expand-lg navStyle navbar-fixed-top mama"  role="navigation" style="background-color: rgba(10, 10, 10, 1);
    ...
    <div class="site-blocks-cover overlay" style="height:300px;background-image: url(images/heroo.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
