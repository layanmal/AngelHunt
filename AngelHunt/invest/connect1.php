...
if( $myArray['0'] === "name" and $myArray['1']==="loc" ){
    
     if($myArray['2'] !="NULL" and $myArray['3'] ==="NULL" ){
        $fullname=explode(" ",$myArray['2']); 
        $first=$fullname[0];
        $last=$fullname[1];
        
           $result = mysqli_query($conn,"SELECT * FROM  registration  where firstname ='$first' AND lastname ='$last' ") or die('Invalid query: ' . mysqli_error($conn));
      } 
      
      else if($myArray['2'] === "NULL" and $myArray['3']!="NULL"){
      $result = mysqli_query($conn,"SELECT * FROM  registration WHERE country='$myArray[3]'") or die('Invalid query: ' . mysqli_error($conn));
      }
      else if($myArray['2'] != "NULL" and $myArray['3'] !="NULL" ){
        $fullname=explode(" ",$myArray['2']); 
        $first=$fullname[0];
        $last=$fullname[1];
      $result = mysqli_query($conn,"SELECT * FROM  registration WHERE firstname ='$first' AND lastname ='$last' and country='$myArray[3]'") or die('Invalid query: ' . mysqli_error($conn));
      }
                        ...
                        <div class="frontside">
                            ...
                            <div class="card">
                                <div class="card-body text-center ">
                                    <p><?php  echo '<img  alt="card image" "class="img-fluid " src="data:image/jpeg; base64,'.base64_encode( $row['pic']).'" />';?>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center ">
                                    ...
                                    <a type="button" href="../startup/personal.php?msg=<?php echo $name; ?>" class="btn btn-primary"style=" border-radius:15px;">visit Profile</a>
                                </div>
