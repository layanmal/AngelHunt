      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 text-center" data-aos="fade">
            ...
            <p><a style="width:200px; border-radius:5px;"  href="#" class="btn btn-outline-warning py-3 px-4">Find Jobs</a> 
            <a href="#" style="border-radius:5px;width:200px;"id="button" class="btn btn-warning py-3 px-4">Get Notified </a></p>
          <script>
...
<div class="limiter" style="margin-left:-620px; margin-top:-400px;display:none;">
      <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-5 mx-auto">
          <div class="card card-signin my-5">
            <div class="card-body">
              ...
              <h2 class="card-title text-center">Get Notified</h2> 
              ...
              <form class="form-signin" action="notify3.php" method="POST">
      <h6  style="margin-left:50px;">Select Job Title you want to be Notified about</h6>

                <select name="job" style="margin-left:120px;">
    ...
    <option value="Full Stack Programmer">Full Stack Programmer</option>
    <option value="Public Relations">Public Relations</option>
  
  </select>
                </div>
  
                <button class="btn btn-lg btn-primary btn-block " style="margin-top:-10px;margin-left:170px;border:white;color:white;width:120px;background-color:#18d26e;"type="submit" name="submit"value="submit">Done!</button>
...
<span class="company-logo blank-logo text-center text-md-left pl-3" style="font-size=18px; color:red" ><?php echo $msg?></span>

<?php $result = mysqli_query($conn,"SELECT *  FROM  jobs ") or die('Invalid query: ' . mysqli_error($conn));
...
?> 
        ...
        <!--<img src="images/company_logo_blank.png" alt="Image" class="img-fluid mx-auto">-->
            ...
            <div class="col-md-12 text-center mt-5">
              <a href="#" style=" margin-left:240px; opacity:0.5; width:250px;" class="btn btn-primary rounded py-3 px-5"><span class="icon-plus-circle"></span> Show More Jobs</a>
--> </div>
          </div>
