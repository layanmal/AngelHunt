    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          ...
          <form method="post" action="push.php?msg=<?php echo $myArray['0']?>" class="p-5 bg-white">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input name="job_title" type="text" id="fullname" class="form-control" placeholder="eg. Full Stack Frontend" required>
                 </div>
                </div>
              </div>
              ...
              <div class="row form-group mb-5">
                <div class="col-md-4 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">day</label>
                  <input name="day" type="text" id="fullname" class="form-control" placeholder="eg. 1st . " required>
                </div>
                <div class="col-md-4 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">month</label>
                  <input name="month" type="text" id="fullname" class="form-control" placeholder="eg. July." required>
                </div>
                <div class="col-md-4 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">year</label>
                  <input name="year" type="text" id="fullname" class="form-control" placeholder="eg. 2020." required>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-1">
                    <input value="Full Times" name="a[]"  type="radio" id="option-job-type-1" > Full Time
                  </label>
                </div>
    
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-3">
                    <input value="Part Time" name="a[]"  type="radio" id="option-job-type-3" > Part Time
                </div>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-4">
                    <input value="Freelance" name="a[]"  type="radio" id="option-job-type-4" > Freelance
                  </label>
                </div>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-4">
                    <input value="Internship" name="a[]" type="radio" id="option-job-type-4" > Internship
                  </label>
                </div>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-4">
                    <input value="Termporary" name="a[]"  type="radio" id="option-job-type-4" > Termporary
                  </label>
                </div>
              ...
              <div class="row form-group mb-4">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <input name="country" type="text" class="form-control" placeholder="USA" required>
                </div>
                <hr>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <textarea name="describtion" class="form-control" id="" cols="30" rows="5" required></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12"><h3>Job Requirements</h3></div>
                <div class="col-md-12 mb-3 mb-md-0">
                  <textarea name="req" class="form-control" id="" cols="30" rows="10" required></textarea>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Post a Job" class="btn btn-primary  py-2 px-5" style="width:170px; color:white" >
                </div>
              </div>
          ...
          <div class="p-4 mb-3 bg-white">
                ...
                <p><a href="#" class="btn btn-primary  py-2 px-4" style="margin-top:15px; margin-right:0px;color:white;">Submit Info</a></p>
