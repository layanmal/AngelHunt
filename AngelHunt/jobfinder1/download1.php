      ...
      <div class="container" style="width:1500px;">
        <div class="row">
          <div class="col-md-8 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
            <h2 style="font-weight: 400px; font-size:32px;color:black ">Received Applications</h2>
 ...
 <?php foreach ($files as $file): 
    if ($file['company']==$msg){
      ...
      $iduser =$file['iduser'];
                  ...
                  $retrieve33=mysqli_fetch_array($result33);
              $fname=$retrieve33['firstname'];
              $lname=$retrieve33['lastname'];
              $name=$fname." ".$lname;?>
              <div class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                <div class="company-logo blank-logo text-center text-md-left pl-3">
                <?php  echo '<img  "class="img-fluid mx-auto" src="data:image/jpeg; base64,'.base64_encode( $retrieve33['pic']).'" />';?>
                </div>
                <div class="job-details h-100">
                  <div class="p-3 align-self-center">
                 <div class="masa" style="display: inline-block;">  
                 <a href="../startup/personal.php?msg=<?php echo $name;?>">
                  <h4 style="display: inline-block;"><?php echo $name; ?></h4> 
    </a>
   </div> 
                ...
                <div class="job-category align-self-center">
                  ...
                  <a href="download.php?file_id=<?php echo $file['id']?>"><span class="btn btn-primary py-2 mr-1">Download</span></a>
