...
<nav class="navbar navbar-expand-lg navStyle navbar-fixed-top mama"  role="navigation" style="background-color: rgba(10, 10, 10, 1);
    ...
    <div class="site-blocks-cover overlay" style="height:300px;background-image: url(images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
  ...
  while ($row = mysqli_fetch_assoc($result)){
          ?>
            <div class="col-md-6 mb-4 mb-lg-0 col-lg-4">
              ...
              <div  style="margin-top:40px"class="listing-item" style="height:245px;">
      ...
      <div class="site-section" style="background-color:#EDEAE0;">
        <div class="container">
          ...
          <div class="row align-items-stretch">
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="Categories.php?msg=Healthcare" class="popular-category h-100">
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="Categories.php?msg=Education" class="popular-category h-100">
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a  href="Categories.php?msg=Marketing/Advertising" class="popular-category h-100">
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="Categories.php?msg=Construction/Real Estate" class="popular-category h-100">
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="Categories.php?msg=E-commerce" class="popular-category h-100">
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="Categories.php?msg=Energy/Water"class="popular-category h-100">
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="Categories.php?msg=Transportation" class="popular-category h-100">
          ...
          <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
            <a href="Categories.php?msg=Technology" class="popular-category h-100">
        ...
        <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
          <a href="Categories.php?msg=Agriculture" class="popular-category h-100">
      ...
      <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
        <a  href="Categories.php?msg=Robotics" class="popular-category h-100">
    ...
    <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
      <a href="Categories.php?msg=Gaming" class="popular-category h-100">
  ...
  <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
    <a href="Categories.php?msg=Human Resources" class="popular-category h-100">
