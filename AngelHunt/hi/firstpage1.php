...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/logo3.png">
    ...
    <div class="home22">
      <section  class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" id="home" data-background="assets/images/agency/2.png">
        ...
        <div class="titan-caption" >
          ...
          <h3 style="color:#18d26e;" class="text-center font-alt" ><?php if($msg !=NULL) echo $msg;?></h3>
