...
?>
<title>AngelHunt | <?php echo $name." "; ?>Profile</title>
...
<body class="profile-page">
   ...
   alt=""    src="data:image/jpeg; base64,'.base64_encode( $retrieve['cover']).'" />';}
                       ...
                       <div   style="margin-top:-180px;" > <?php if(!empty($retrieve['pic'])) {
        echo '<div  " class="boxxx" style="background-image:url(data:image/jpeg;base64,'.base64_encode( $retrieve['pic'] ).')"/>';
        
    } else { 
     
        echo '<a class="boxxx"  style="background-image:url(https://www.kindpng.com/picc/m/78-785827_user-profile-avatar-login-account-male-user-icon.png)"/>';
}?></div>	
...
echo' <a href="profile.php?msg='.$retrieve2['StartupName'].'"> <img   class="rounded" style="height:100px; width:100px;"
       src="data:image/jpeg; base64,'.base64_encode( $retrieve2['imageType']).'" /> </a>';
                       
}?>						</div>
      				<div class="col-md-4 mr-auto">
                      <?php $result3=mysqli_query($conn,"SELECT * FROM Investors WHERE startemail='$email' LIMIT 10");

while($retrieve3=mysqli_fetch_array($result3)){
echo' <a href="profile2.php?msg='.$retrieve3['companyname'].'"><img class="rounded" style="height:100px; width:100px;"
