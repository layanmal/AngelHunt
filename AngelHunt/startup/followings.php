...
$result=mysqli_query($conn,"SELECT following ,idname FROM followers WHERE idname='$id'");
while($row=mysqli_fetch_array($result)){
  $company=$row['following'];

    $result4=mysqli_query($conn,"SELECT * FROM corporates WHERE companyname='$company'"); 
    if($result4->num_rows===0){
        
    }
    else{
    while($rob4=mysqli_fetch_assoc($result4)){
            
        ?>
    <div class="rounded border jobs-wrap">
   <div class="card">      
     <h2 class="fa fa-gears" style="color:#18d26e; padding:15px;"></h2>
      <span for="email" class="card-title11 " style="font-size:18px; text-center:left">Followed corporates</span>
        <hr>
         
        
          <a href="../jobfindernew/job-single.php?msg=2,<?php echo $rob4['companyname'];?>" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
         <div class="company-logo blank-logo text-center text-md-left pl-3">
           <?php  echo '<img  "class="img-fluid mx-auto" src="data:image/jpeg; base64,'.base64_encode( $rob4['pic']).'" />';?>
          </div>
        <div class="job-details h-100">
         <div class="p-3 align-self-center">
          <h3> <?php echo $rob4['companyname'];?> </h3>
       <div class="d-block d-lg-flex">
      <div class="mr-3"><span class="icon-suitcase mr-1"></span>  <?php echo $rob4['country']?></div>
      <div class="mr-3"><span class="icon-room mr-1"></span> <?php echo $rob4['city']?></div>
          </div>
     </div>
   </div>
...
<?php 
    ...
    $result5=mysqli_query($conn,"SELECT * FROM startups WHERE StartupName='$company'"); 
    if($result5==false){
      
    }
    else{
    while($rob5=mysqli_fetch_assoc($result5)){
            
        ?>
    <div class="rounded border jobs-wrap">
   <div class="card">      
     <h2 class="fa fa-gears" style="color:#18d26e; padding:15px;"></h2>
      <span for="email" class="card-title11 " style="font-size:18px; text-center:left">Followed Startups</span>
        <hr>
         
        
          <a href="../jobfindernew/job-single.php?msg=2,<?php echo $rob5['StartupName'];?>"  class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
         <div class="company-logo blank-logo text-center text-md-left pl-3">
           <?php  echo '<img  "class="img-fluid mx-auto" src="data:image/jpeg; base64,'.base64_encode( $rob5['imageType']).'" />';?>
          </div>
        <div class="job-details h-100">
         <div class="p-3 align-self-center">
          <h3> <?php echo $rob5['StartupName'];?> </h3>
       <div class="d-block d-lg-flex">
      <div class="mr-3"><span class="icon-suitcase mr-1"></span>  <?php echo $rob5['Country']?></div>
      <div class="mr-3"><span class="icon-room mr-1"></span> <?php echo $rob5['City']?></div>
          </div>
     </div>
   </div>
 <div class="job-category align-self-center">
   ...
   <?php 
    ...
    $result6=mysqli_query($conn,"SELECT * FROM investors WHERE companyname='$company'");
    if($result6->num_rows ===0){
    }
    else{
    while($rob6=mysqli_fetch_assoc($result4)){
            
        ?>
    <div class="rounded border jobs-wrap">
   <div class="card">      
     <h2 class="fa fa-gears" style="color:#18d26e; padding:15px;"></h2>
      <span for="email" class="card-title11 " style="font-size:18px; text-center:left">followed Investors</span>
        <hr>
         
        
          <a href="../jobfindernew/job-single.php?msg=2,<?php echo $rob6['companyname'];?>"  class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
         <div class="company-logo blank-logo text-center text-md-left pl-3">
           <?php  echo '<img  "class="img-fluid mx-auto" src="data:image/jpeg; base64,'.base64_encode( $rob6['pic']).'" />';?>
          </div>
        <div class="job-details h-100">
         <div class="p-3 align-self-center">
          <h3> <?php echo $rob6['companyname'];?> </h3>
       <div class="d-block d-lg-flex">
      <div class="mr-3"><span class="icon-suitcase mr-1"></span>  <?php echo $rob6['country']?></div>
      <div class="mr-3"><span class="icon-room mr-1"></span> <?php echo $rob6['city']?></div>
          </div>
     </div>
   </div>
 <div class="job-category align-self-center">
