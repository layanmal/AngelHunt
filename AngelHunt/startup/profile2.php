...
$result=mysqli_query($conn,"SELECT id,companyname,type,typeinv,pic,cover,bio,facebook,twitter,linkedin,website,branches,min,max,country,city,street,institution,typeinst FROM investors WHERE companyname='$StartupName'");
if (!$result) {
  printf("Error: %s\n", mysqli_error($conn));
  exit();
}
...
<div class="twPc-div">
	...
	<div>
		...
		<a title="Profile Image"style="margin-left:50px;"  class="twPc-avatarLink">
  <?php  echo '<img  class="twPc-avatarImg" src="data:image/jpeg;base64,'.base64_encode( $retrieve['pic'] ).'" height="170" width="170"/>';?>
    ...
    echo'<a href="unfollow2.php?msg='.$company.'"  style="float:right; margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd " data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true">Unfollow</a>';

}else{
    echo'<a href="follow2.php?msg='.$company.'" style="float:right; margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd " >Follow</a>';
} ?>

     
      <!-- <a href="follow.php?msg="  style="float:right; margin-right:7px;" class="btn btn-finish btn-fill btn-danger btn-wd " data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true">Follow</a>
       -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card rounded card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                        ...
                        <h6 class="ser-title">Type of Investment</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                      <?php     
                       $result = mysqli_query($conn,"SELECT * FROM  invrounds
     ...
     <h2 class="	fa fa-gears" style="color:#18d26e; padding:15px;"></h2>
      <span for="email" class="card-title11 " style="font-size:18px; text-center:left">jobs</span>
        <hr>
          ...
          <a href="../jobfindernew/job-single.php?msg=2,<?php echo $row['company'];?>"  class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
         <div class="company-logo blank-logo text-center text-md-left pl-3">
