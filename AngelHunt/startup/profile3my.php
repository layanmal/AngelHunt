...
//echo $StartupName;
//StartupName="Fikra Innovation Group";
$result=mysqli_query($conn,"SELECT id,companyname,type,investwith,bio,pic,cover,imageData,website,linkedin,twitter,facebook,country,city,street,branches,cityf,countryf,stagef,focus,linked,typeinst FROM corporates WHERE companyname='$StartupName'");
if (!$result) {
  printf("Error: %s\n", mysqli_error($conn));
  exit();
}
...
<head>
  ...
  <link href="assets/css/paper-bootstrap-wizard.css?333" rel="stylesheet" />
...
<div class="twPc-div">
  ...
  <?php  echo '<img style="  border: 0px solid black;" class="twPc-avatarImg" src="data:image/jpeg;base64,'.base64_encode( $retrieve['pic'] ).'" height="170" width="170"/>';?>
		</a>

		<div class="twPc-divUser">
			<div class="twPc-divName">
       <a  style="float:right; margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd " data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true" href="mess.php?msg=<?php echo $company?>">Message</a>
...
<b>  <span for="email" class="card-title11 " style="font-size:19px; text-center:center"> Received Applications </span></b>
<hr>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Listed Below Funding Done by The Company</p>
                </div>
                <div class="card-body">
