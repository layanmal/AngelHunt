...
//echo $StartupName;
$result=mysqli_query($conn,"SELECT id,StartupName,Type,Cofounders,imageType,cover,Country,City,Street,Teammem,facebook,twitter,linkedin,website,Datefounded,stage,money,startupgenerating,problem,future,teamneeds FROM startups WHERE StartupName='$StartupName'");
if (!$result) {
  printf("Error: %s\n", mysqli_error($conn));
  exit();
}
...
$start=$retrieve['StartupName'];
$teamneeds=$retrieve['teamneeds'];
$type=$retrieve['Type'];
$cofounders=$retrieve['Cofounders'];
$team=$retrieve['Teammem'];
$facebook=$retrieve['facebook'];
$twitter=$retrieve['twitter'];
$linkedin=$retrieve['linkedin'];
$website=$retrieve['website'];
$date=$retrieve['Datefounded'];
$stage=$retrieve['stage'];
$money=$retrieve['money'];
$generating=$retrieve['startupgenerating'];
$country=$retrieve['Country'];
$city=$retrieve['City'];
$street=$retrieve['Street'];
$problem=$retrieve['problem'];
$future=$retrieve['future'];
$flag="";
...
if (!$resultnew) {
 ...
 while($row2new=mysqli_fetch_array($result1new)){
  if($StartupName ==$row2new['following'] ){
    $count++;
  }
   
  if($StartupName == $row2new['following'] and $id == $row2new['idname']){
   $true=TRUE;
  }
  else{
    $true=FALSE;
...
<head>
  ...
  <link href="assets/css/paper-bootstrap-wizard.css?2399999999" rel="stylesheet" />
...
<?php if(!empty($retrieve['cover'])){
        ...
        echo '<img class="twPc-bg twPc-block"  style="background-image:url(https://www.oberlo.com/wp-content/uploads/2017/06/shutterstock_374648065-880x470-c.jpg)"/>';
}?>

	<div>
		
	
		<a title="batikha" style="margin-left:50px;" class="twPc-avatarLink">
  <?php  echo '<img  class="twPc-avatarImg" src="data:image/jpeg;base64,'.base64_encode( $retrieve['imageType'] ).'" height="170" width="170"/>';?>
		</a>
    ...
    echo'<a href="unfollow.php?msg='.$StartupName.'"  style="float:right; margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd " data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true">Unfollow</a>';

}else{
    echo'<a href="follow.php?msg='.$StartupName.'" style="float:right; margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd " >Follow</a>';
} ?>

      <a  style="float:right;margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd " data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true" onclick="openForm()">Message</h1>
      <a href="<?php echo $row['$website'];?>" target="_blank" style="float:right;margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd " data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true">Website</h1>
      <a  href="<?php echo $website ?>"> <span style="color:black; font-size:25px;margin-left:10px;margin-top:30px;"><?php 
echo $start;
?> <span></a>
			</div>
			<span>
				<!-- <a href="" target="_blank"><span style ="font-size:16px"><strong>my Website account</strong></span></a> -->
			</span>
		</div>
...
<div class="container" style="margin-top:90px;font-weight:700px;">
...
<div class="py-5 service-24" >
 <!-- <span > <textarea  rows="3" cols="110" style="border-color:white">
        ...
        <div class="row wrap-service-24 col-lg-9 col-md-12">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card rounded card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
										<b style="font-weight:300px;">		<span class="bg-success-grediant" ><?php echo $date;?></span></b>
                        <h6 class="ser-title">Date Founded</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                    <b style="font-weight:300px;">			<span class="bg-success-grediant" ><?php echo $type;?></span></b>
                        <h6 class="ser-title">Industry Type</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                    <b style="font-weight:300px;">		<span class="bg-success-grediant"><?php echo $cofounders;?></span></b>
                        <h6 class="ser-title">Founders</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                    <b style="font-weight:300px;">			<span class="bg-success-grediant"><?php echo $money;?></span></b>
                        <h6 class="ser-title">Goal to Raise</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                    <b style="font-weight:300px;">				<span class="bg-success-grediant"><?php echo $stage;?></span></b>
                        <h6 class="ser-title">Development Stage</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                    <b style="font-weight:300px;">				<span class="bg-success-grediant"><?php echo $team;?></span></b>
                        <h6 class="ser-title">Team Members</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                    <b style="font-weight:300px;">				<span class="bg-success-grediant"><?php echo $generating;?></span></b>
                        <h6 class="ser-title">Revenue generating</h6>
                    </a>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-shadow border-0 mb-4">
                    <a href="javascript:void(0)" class="card-hover py-4 text-center d-block rounded"> 
                    <b style="font-weight:300px;">			<span class="bg-success-grediant">C</span></b>
                        <h6 class="ser-title">Linked Institution</h6>
                    </a>
                </div>
            </div>
 ...
 <br>  
            ...
            <div class="card">
                    <div class="card-body11" style="margin-left:20px;padding-left:5px;">
                        ...
                        <b><span  class="card-title11 " style="font-size:19px; text-center:center">Requirements</span></b>
<hr>
                        <div class="form-group">
                            <label for="email" class="col-form-label "style="font-size:15px;">This Startup Needs:</label>
                            <span for="email" class="col-form-label"style="font-size:15px;"><?php echo $teamneeds ?></span>
<br>
 <br>
 <br>     
                        </div>  
...
<div class="row wrap-service-24">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category" style="color:white;"> Listed Below Investments In This Business </p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                   ...
                   <tbody >
                      <?php     
                       $result = mysqli_query($conn,"SELECT * FROM  rounds
                      WHERE startup ='$StartupName'") or die('Invalid query: ' . mysqli_error($conn));
  ...
  <b>   <span for="email" class="card-title11 " style="font-size:22px; text-center:left">Suggested Investors</span></b>
  <hr>
  <div class="ex3">
        ...
        ?>
                      ...
                      <a href="../invest/validation2.php?msg=<?php echo $row['companyname'];?>"  class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                        ...
                        <h3> <?php echo $row['companyname'];
                            $_SESSION["StartupName"]=$row['companyname']?></h3> 
   ...
   <b>  <span for="email" class="card-title11 " style="font-size:22px;text-center:left">Related Startups</span></b>
  <hr>
  <div class="ex3">
              <?php  
 ...
 <div class="p-3">
  <span class="text-info p-2 rounded border border-info">Apply</span>
   ...
   <?php
    ...
    <div class="card">
    <h2 class=" far fa-bookmark" style="color:#18d26e; padding:15px;"></h2>
<b>     <span for="email" class="card-title11 " style="font-size:20px; text-center:left">Know More About Us</span></b>
  <hr>
<div class="py-5 service-24" >
     <div class="container">
        <!-- Row -->
       ...
       <b> <h3 style='text-align:left;'>Problem Business Is Trying to Solve<h3></b>
          <p style='text-align:left;'><?php echo $problem?></p>
          <hr>
    
          <h3 style='text-align:left;'>Our Future plan ?<h3>
           
            
          <p style='text-align:left;'><?php echo $future?></p>
          <hr>
...
<div class="chat-popup" id="myForm" style="height: auto;
  ...
  <div class="card22-header msg_head " >
    ...
    <span class="close" onclick="closeForm()">x</span>
							<div class="d-flex bd-highlight">
								<div class="img_cont">
                  <?php echo'<img src="data:image/jpeg;base64,'.base64_encode( $retrieve['imageType'] ).'" class="rounded-circle user_img">'
								?>
									<span class="online_icon"></span>
								</div>
								<div class="user_info" >
									<span>Chat with <?php echo $retrieve['StartupName'] ?></span>
									<p><h3 id=suceess><h3></p>
								</div>
...
>
              <div class="d-flex justify-content-start mb-4" >
								...
								<?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $retrieve['imageType'] ).'" class="rounded-circle user_img_msg">'?>
								</div>
