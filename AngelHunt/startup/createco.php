...
$retrieve22=mysqli_fetch_array($result22); if(!empty($retrieve22['pic'])){   echo'<img style="  float: none;
            ...
            Logout </a>
		        ...
		        <div class="col-sm-8 col-sm-offset-2" style="margin-bottom:30px;margin-top:50px;">
		            ...
		            <div class="wizard-container">
		                ...
		                <form action="push3.php" method="POST" enctype="multipart/form-data">
		                <!-- You can switch " data-color="green" "  with one of the next bright colors: "blue", "azure", "orange", "red"       -->

		                    	<div class="wizard-header">
		                        	<h3 class="wizard-title" style="font-weight:500">Create your Corporate's Profile</h3>
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="location">
		                            	<div class="row">
		                                	<div class="col-sm-12">
											<hr>
		                             <h6 class="info-text" Style="margin-left:60px;text-align:left"> Basic Information </h6>
		                            		<br>
		                            		</div>
		                                	<div class="col-sm-5 col-sm-offset-1">
		                                    	<div class="form-group">
		                                        	<label>Company Name</label>
		                                        	<input  name="company_name" value="startup name" type="text" class="form-control"  placeholder="What is the name of your startup?">
		                                    	</div>
		                                	</div>
		                                	<div class="col-sm-5 ">
		                                    	<div class="form-group">
		                                        	<label>Corporates Type</label>
		                                        	<select class="form-control" name="corporates">
			                                            <option disabled="" selected="">- type -</option>
			                                            <option value="Corporate">Corporate</option>
			                                            <option value="Corporates Accelator">Corporates Accelator</option>
														<option value="Corporates VC">Corporates VC</option>
		                                	...
		                                	<div class="col-sm-5 col-sm-offset-1">
		                                    	<div class="form-group">
													...
													<select name="type_inv" class="form-control">
											...
											<div class="col-sm-5 ">
		                                    	<div class="form-group">
		                                        	...
		                                        	<div class="input-group" >
		                                            	<input  name="pic" type="file" class="form-control" placeholder="Startup logo">
											...
											<div class="col-sm-10 col-sm-offset-1">
		                                    	<div class="form-group">
		                                        	...
		                                        	<div class="input-group" >
		                                            	<input  name="cover" type="file" class="form-control" placeholder="company cover">
   ...
   <option value="Zimbabwe">Zimbabwe</option>
												...
												<hr>
												<h6 Style="" class="info-text1">Highligh Your Focus</h6>
                                                  <br>
												</div>
                                                <div class="col-sm-5 col-sm-offset-1 ">	
													<div class="form-group">
														<label> Development Focus Interest</label><br>
														<select name="stagef" class="form-control">
                                                    ...
                                                    <div class="col-sm-5 ">
		                                    	<div class="form-group">
		                                        	<label>amount you are willing to invest with</label>
		                                        	<input  name="invest_with" value="startup name" type="text" class="form-control"  placeholder="What is the name of your startup?">
		                                    	</div>
		                                	</div>
                                                    <div class="col-sm-5 col-sm-offset-1">	
													<div class="form-group">
														<label> Country Focus</label><br>
														<select name="countryf" class="form-control">
														<option value="N/A">N/A</option>
														<option value="Afganistan">Afghanistan</option>
   <option value="Albania">Albania</option>
   <option value="Algeria">Algeria</option>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
													...
													<div class="form-group">
		                                        	<label>City*</label>
		                                        	<input name="cityf"  type="text" class="form-control"  placeholder="-Name of the city-">
		                                    	   </div>
												</div>
												<div class="col-sm-12 col-sm-offset-1">
												<hr>
												<h6 Style="" class="info-text1"> Social media</h6>
                                                  <br>
												</div>
												<div class="col-sm-5 col-sm-offset-1">
												...
												<input  class="form-control" type="url" id="linkedin" name="linked in" placeholder="-Linkedin-">
												 </div> 
												 <div class="col-sm-5 ">
