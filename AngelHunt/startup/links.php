...
<div class="col-md-9" >
   ...
   <div class="card">      
     <h2 class="fa fa-gears" style="color:#18d26e; padding:15px;"></h2>
      <span for="email" class="card-title11 " style="font-weight:500;font-size:18px; text-center:left">Linked corporates</span>
        <hr>
        <?php 
  $result4=mysqli_query($conn,"SELECT * FROM corporates WHERE email='$email'");
    if($result4==false){
    }
    else{
    while($rob=mysqli_fetch_assoc($result4)){
        ...
        ?>
          ...
          <a href="../invest/validation3.php?msg=<?php echo $rob['companyname'];?>"  class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
         <div class="company-logo blank-logo text-center text-md-left pl-3">
           <?php  echo '<img  "class="img-fluid mx-auto" src="data:image/jpeg; base64,'.base64_encode( $rob['pic']).'" />';?>
          </div>
        <div class="job-details h-100">
         <div class="p-3 align-self-center">
          <h3> <?php echo $rob['companyname'];?> </h3>
 ...
 <div class="job-category align-self-center">
  ...
  <?php
   ...
   <div class="card">      
     <h2 class="fa fa-gears" style="color:#18d26e; padding:15px;"></h2>
      <span for="email" class="card-title11 " style="font-size:18px; text-center:left">Linked Startups</span>
        <hr>
        <?php 
  $result5=mysqli_query($conn,"SELECT * FROM startups WHERE startemail='$email'");
    if($result5==false){
    }
    else{
    while($rob1=mysqli_fetch_assoc($result5)){
            
        ?>
        
          <a href="../searchs/validation.php?msg=<?php echo $rob1['StartupName'];?>"  class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
         <div class="company-logo blank-logo text-center text-md-left pl-3">
           <?php  echo '<img  "class="img-fluid mx-auto" src="data:image/jpeg; base64,'.base64_encode( $rob1['imageType']).'" />';?>
          </div>
        <div class="job-details h-100">
         <div class="p-3 align-self-center">
          <h3> <?php echo $rob1['StartupName'];?> </h3>
       <div class="d-block d-lg-flex">
      <div class="mr-3"><span class="icon-suitcase mr-1"></span>  <?php echo $rob1['Country']?></div>
      <div class="mr-3"><span class="icon-room mr-1"></span> <?php echo $rob1['City']?></div>
          </div>
     </div>
   </div>
 <div class="job-category align-self-center">
  ...
  <?php
   ...
   <div class="card">      
     <h2 class="fa fa-gears" style="color:#18d26e; padding:15px;"></h2>
      <span for="email" class="card-title11 " style="font-size:18px; text-center:left">Linked Investors</span>
        <hr>
        <?php 
  $result6=mysqli_query($conn,"SELECT * FROM investors WHERE startemail='$email'");
    if($result6==false){
    }
    else{
    while($rob6=mysqli_fetch_assoc($result6)){
            
        ?>    
        
          <a href="../invest/validation2.php?msg=<?php echo $rob6['companyname'];?>"  class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
         <div class="company-logo blank-logo text-center text-md-left pl-3">
