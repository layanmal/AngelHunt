...
<head>
  ...
  <link href="assets/css/paper-bootstrap-wizard.css?23673" rel="stylesheet" />
...
<?php if(!empty($retrieve['cover'])) {
  ...
  <?php  echo '<img  class="twPc-avatarImg" src="data:image/jpeg;base64,'.base64_encode( $retrieve['imageType'] ).'" height="170" width="170"/>';?>
      ...
      <a href="../jobfinder1/new-post.php?job=1,<?php echo $StartupName?>"  style="float:right;margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd" data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true">post a job</a>
      <a href="../jobfinder1/announcment.php?msg=<?php echo $StartupName ;?>" target="_blank" style="float:right;margin-right:7px;margin-top:30px;" class="btn btn-finish btn-fill btn-danger btn-wd" data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true">Break an Announcement</a>
<?php
echo $start;
?> </a>
			</div>
...
<div class="card">
                    <div class="card-body11" style="margin-left:20px;padding-left:5px;">
                     ...
                     <b>   <a href="../jobfinder1/download1.php?msg=<?php echo $StartupName?>"  class="card-title11 " style="font-size:18px; color:black;text-center:center">Recieved Applications</a></b>
<hr>
