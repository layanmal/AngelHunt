    ...
    <section class="site-section py-lg">
      ...
      ?>
            ...
            <div class="row mb-5 mt-5">
              ...
              <?php  echo '<img  class="img-fluid rounded" src="data:image/jpeg; base64,'.base64_encode( $row['pic']).'" />';?>
               </div>
          </div>
             
          <br> <p><?php echo $row['goal'] ?></p>
...
<b>  <p >Categories:</span> <a href="#"><?php  echo $row['type']?> </a>, <a href="#">Travel</a>  <br>
                Tags: <a href="#">#<?php $row["country"]?> </a>, <a href="#">#<?php $row["city"]?></a></p></b>
            </div>
          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <!-- END sidebar-box -->
            <div class="sidebar-box" style=" background-color: #f5f5f5;">
              <div class="bio text-center">
                <img src="leader.png"  style="margin-top:30px;height:80px;width:200px;"alt="Image Placeholder" class="img-fluid mb-5">
                <div class="bio-body">
                  <h2> <?php  echo $row['company']?></h2>
                  <p class="mb-4"><?php echo $bio  ?> </p>
                  <p><a href="<?php echo $row["website"] ?>" class="ready-btn right-btn page-scroll"> Visit Profile</a></p>
                  <p class="social">
                    <a href="#" style="color:black;" class="p-2"><span class="fa fa-facebook"></span></a>
                    <a href="#" class="p-2"><span class="fa fa-twitter"></span></a>
                    <a href="#" class="p-2"><span class="fa fa-linkedin-in"></span></a>
           ...
           <div class="left-blog">
                  ...
                  <div class="p-4 mb-3 ">
                    ...
                    <p class="mb-4"><?php echo $row['city']  ?><?php echo " " ?><?php echo $row['country']  ?></p>
      
                    <p class="mb-0 font-weight-bold">Phone</p>
                    <p class="mb-4"><a href="#"><?php echo $row['telephone']?> </a></p>
      
                    <p class="mb-0 font-weight-bold">Email Address</p>
                    <p class="mb-0"><a href="#"><?php echo $row['telephone']?> </a></p>
                  </div>
                </div>
                 </div>
                </div>
